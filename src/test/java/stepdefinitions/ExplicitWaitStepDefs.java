...
public class ExplicitWaitStepDefs {
    ...
    public void user_waits_fluently_until_the_page_loads_and_verify_the_text_message() {
        ...
        WebElement mesajHelloWorld = wait.until(new Function<WebDriver, WebElement>(){

            public WebElement apply(WebDriver driver ) {
                return driver.findElement(By.xpath("//*[.='Hello World!']"));
            }
        });

       // WebElement mesaj = wait.until(driver -> driver.findElement(By.xpath("//*[.='Hello World!']")));
       ...
       // WebElement message = Driver.getDriver().findElement(By.id("message"));
        Assert.assertEquals(mesajHelloWorld.getText(),"Hello World!");
    }
}
